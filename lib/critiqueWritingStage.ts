...
- **Naive / poster-flat / symbolically simplified work (strict profile):** only when the evidence describes **uniform outlines, flat unmodulated color, symbolic shapes, and little light, value, or spatial development**. Then Voice A may assign **Beginner** on **most** criteria—often **six to eight**—matching that profile. **Do not** apply this cluster to **impressionistic, pastel-heavy, or high-chroma landscapes** where the evidence shows **layered strokes, light/shadow pattern, depth, broken color, or temperature structure**—those warrant **per-criterion** grades (often **Intermediate** or **Advanced** on value, color, surface, composition, etc., when the evidence supports it). **Vivid palette alone is never a reason for all Beginner.**
